...
import { getIntegrationsForTier, getLockedIntegrations } from '@repo/integrations/nango/config';
          ...
          <TabsContent value="available" className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {availableIntegrations.map((integration) => {
                const IconComponent = Icons[integration.icon as keyof typeof Icons] || Icons.PlugIcon;
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            <CardTitle className="text-base">{integration.name}</CardTitle>
                            <ProBadge tier={integration.requiredTier} />
                          </div>
                        </div>
                      </div>
                    </CardHeader>
